if (void 0 === trbtn) var trbtn = trbtn || function() {
    var t = -1,
        n = [],
        r = "",
        e = "";
        ...
        updateSize: function(t) {
            var r, e, o, a = 0,
                i = setInterval(function() {
                    r || (r = document.getElementById("trbtn-container-" + t)), r && document.body.contains(r) && (e || (e = r.querySelector(".trbtn")), e.clientWidth !== a && (r.style.width = e.clientWidth * n[t].size + "px", r.style.height = e.clientHeight * n[t].size + "px"), a = e.clientWidth, o || (o = e.querySelector(".trbtn-img")), o.complete && document.fonts && document.fonts.check && document.fonts.check("bold 16px quicksand") && document.fonts.check("bolder 16px quicksand") && clearInterval(i))
                }, 100)
        },
        draw: function(t) {
            var o = n[t];
            document.writeln(r.replace("[src]", o.src) + e.replace("[color]", o.color).replace("[text]", o.text).replace("[src]", o.src).replace("[url]", o.url).replace("[size]", o.size))
        }
    }
}();
