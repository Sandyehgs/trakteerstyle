if (void 0 === trbtnOverlay) var trbtnOverlay = trbtnOverlay || function() {
    var t = -1,
        e = [],
        n = null,
        r = "",
        ...
        updateSize: function(t, n = null) {
            var r, o, a, i = 0,
                l = setInterval(function() {
                    r || (r = document.getElementById("trbtn-overlay-container-" + t)), r && document.body.contains(r) && (o || (o = r.querySelector(".trbtn")), o.clientWidth !== i && (r.style.width = o.clientWidth * e[t].size + "px", r.style.height = o.clientHeight * e[t].size + "px", n && n(r)), i = o.clientWidth, a || (a = o.querySelector(".trbtn-img")), a.complete && document.fonts && document.fonts.check && document.fonts.check("bold 16px quicksand") && document.fonts.check("bolder 16px quicksand") && clearInterval(l))
                }, 100)
        },
        draw: function(t) {
            var a = e[t],
            ...
            d.innerHTML = o.replace("[color]", a.color).replace("[text]", a.text).replace("[src]", a.src).replace("[url]", a.url).replace("[size]", a.size).replace("[pos]", a.pos), c.parentNode.insertBefore(d.firstChild, c)
        }
    }
}();
